...
import com.example.aplikasiuntukuts.model.CheeseDao;
import com.example.aplikasiuntukuts.model.CheeseDatabase;
...
public class SampleContentProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        if (code == CODE_CHEESE_DIR || code == CODE_CHEESE_ITEM) {
            ...
            CheeseDao cheese = CheeseDatabase.getInstance(context).cheese();
            final Cursor cursor;
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        switch (MATCHER.match(uri)) {
            case CODE_CHEESE_DIR:
                ...
                final long id = CheeseDatabase.getInstance(context).cheese()
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection,
        ...
        switch (MATCHER.match(uri)) {
            ...
            case CODE_CHEESE_ITEM:
                ...
                final int count = CheeseDatabase.getInstance(context).cheese()
